...
console.log("Creating PR via gh (will fall back to link if it fails)...");

try {
  sh(
    `gh pr create --title "Agent: ${row.title}" --body "Generated by AI Agent Runner" --base main --head ${branchName}`
  );
  console.log("✅ PR created successfully.");
} catch {
  console.warn("⚠️ gh PR creation failed (auth/scopes). Use the link above to create it manually.");
}
